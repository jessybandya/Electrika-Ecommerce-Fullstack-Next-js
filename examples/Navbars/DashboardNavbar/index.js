...
import SignIn from "../../../components1/Header/SignIn";
import Signup from "../../../components1/Header/Signup";
...
import Headercategory from "../../../sub-components/Header";
      ...
      <Toolbar sx={(theme) => navbarContainer(theme)} style={{display:'flex'}}>
        <SoftBox color="inherit" mb={{ xs: 1, md: 0 }} sx={(theme) => navbarRow(theme, { isMini })}>
          ...
          <SoftBox sx={(theme) => navbarRow(theme, { isMini })}>
            {authId ?(
              ...
              style={{fontWeight:'bold',color:'#2152ff',cursor:'pointer',marginRight:8}}
              onClick={handleShow4}
            >
              Categories
            </SoftTypography>
              ...
              fontWeight="medium"
              color={light ? "white" : "dark"}
              style={{marginRight:8,cursor:'pointer',fontWeight:'bold',color:"#2152ff",display:'flex'}}
              onClick={() => setAboutModal(true)}
              >
              <div style={{display:'flex',alignItems:'center'}}>
              <div>{numberOfRatings === 0 ?(<>0</>):(<>{a}</>)}</div><div><StarIcon style={{color:'#FFD700',marginTop:-4}}/></div>
              </div>
            </SoftTypography>
            <SoftTypography
            variant="button"
          ...
          className='smallDeviceToNotDisplayed'
          >
          <Badge color="error" badgeContent={numberOfCartItems}>
        ...
        {authId === "L0HxxASCIzgqHJJDYS2cDCzWKLK2" ?(
          ...
          <div className='largeDeviceToNotDisplayed'><PowerSettingsNewIcon fontSize="medium" onClick={logout} style={{cursor:'pointer',color:'#2152ff'}}/></div>
            ...
            >
            <div style={{display:'flex',alignItems:'center'}}>
            <span>{numberOfRatings === 0 ?(<>0</>):(<>{a}</>)}</span><span><StarIcon style={{color:'#FFD700',marginTop:-4}}/></span>
            </div>
          </SoftTypography>
            <SoftTypography
            variant="button"
...
<Modal.Body>
    <ContactUs setContactModal={setContactModal} setModalShow={setModalShow}/>
</Modal.Body>
</Modal>
...
<span><span style={{padding:4,borderRadius:8,fontWeight:'bold',color:'#2152ff',fontSize:18,cursor:'pointer'}} onClick={clearCart}><a className="cart-checkout-btn hover-btn">Clear Cart</a></span></span> <span style={{fontWeight:'bold'}}>CART</span> <span><ClearIcon style={{cursor:'pointer',color:'#2152ff'}} onClick={handleCloseCart}/></span>
</div>
</Modal.Header>
<Modal.Body style={{
...
<Headercategory handleClose={handleClose4}/>
</Modal.Body>
</Modal>
    </>
  );
